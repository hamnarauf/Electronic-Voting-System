<%-- 
Document   : EditPollingOfficer
Created on : May 26, 2021, 12:01:41 PM
Author     : Binary Beats
--%>
...
<html>
    <head>
        ...
        <title>Edit Polling Officer</title>
    ...
    <body>
                ...
                <div class="form form1">
                    <div class="wrapper">
                        ...
                        <form id="remove" novalidate action = "EditUserServlet" method = "POST">
                            ...
                            <input type="hidden" name="type" value="Polling officer">
                            <input type="hidden" name="returnDestination" value="PollingOfficers.jsp">
                ...
                <div class="overlay-container">
                    <div class="overlay">
                        <div class="overlay-left">
                            <h1>Polling Officer<br> Removal</h1>

                            <button id="removeButton">Remove</button>
                        </div>
                        <div class="overlay-right">
                            <h1>Polling Officer <br>Registration</h1>
        ...
        <div>
            <a href="PollingOfficers.jsp" target="_parent"> <button class=" button">Back </button></a>
        </div>
