...
function sampleAcquired(s) {
    if (currentFormat === Fingerprint.SampleFormat.PngImage) {
        ...
        fingerprint = Fingerprint.b64UrlTo64(samples[0]);
        
        var imgWidth = (localStorage.getItem("imageSrc")).clientWidth;
        var imgHeight = (localStorage.getItem("imageSrc")).clientHeight;
        localStorage.setItem("width", imgWidth);
        localStorage.setItem("height", imgHeight);
        localStorage.setItem("imageSrc", "data:image/png;base64," + fingerprint);
