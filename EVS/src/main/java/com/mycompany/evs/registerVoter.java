...
import static com.mycompany.evs.BiometricVerificationServlet2.getFmdOfVoterFingerprint;
...
public class registerVoter extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DbQuery.registerVoter(cnic, fmdVoter);

        } catch (SQLException ex) {
            Logger.getLogger(registerVoter.class.getName()).log(Level.SEVERE, null, ex);
        }
